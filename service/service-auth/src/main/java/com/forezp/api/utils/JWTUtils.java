...
import com.forezp.api.util.RedisUtil;
...
public class JWTUtils {
     ...
     * @return token
     */
    public String generateToken(UserInfoTwo user) throws Exception {
