package com.forezp.servicegateway.utils;
...
public class EncryptUtil {
     ...
     * @throws Exception
     */
    public static EncryptUtil getEncryptUtil(String deSkey, String charset) throws Exception {
        if (encryptUtil == null) {
            synchronized (EncryptUtil.class) {
                if (encryptUtil == null) {
                    encryptUtil = new EncryptUtil(deSkey, charset);
                }
            }
        }
        return encryptUtil;
