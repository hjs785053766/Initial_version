...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/business/business-modular-feign" + "/src/main/java");
        gc.setAuthor("hjs");                    //作者
        ...
        dsc.setUrl("jdbc:mysql://192.168.79.130:3306/Maker_test?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true");
